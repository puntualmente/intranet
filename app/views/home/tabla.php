...
<head>
    ...
    <title>Coordinadores Tablas | Puntualmente</title>
                            ...
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody id="vistaObservaciones">
                                        ...
                                        $query = $pdo->query("SELECT n_user, l_user, f_h, observaciones,campana FROM observacion_coordinadores WHERE DATE(f_h)  = '{$hoy}'");

    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon position-relative" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="mostrarnotify()">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-13 text-muted">
                                        ...
                                        <!-- <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span><?php //echo $language["3_min_ago"]; 
                                                                                                            ?></span></p> -->
                                    </div>
                                </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item topbar-light bg-light-subtle border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="<?php echo controlador::$rutaAPP ?>app/assets/images/users/<?php echo $_SESSION['img'] ?>" alt="Header Avatar">
                ...
                <?php if ($_SESSION['rol'] == 1) { ?>
                    ...
                    <li>
                        ...
                        <a href="campana">
                            ...
                            <span data-key="t-horizontal">Campañas</span>
                        </a>
                    </li>
                    <li>
                        <a href="tabla">
                            
                            <span data-key="t-horizontal">Tabla Campañas</span>
                        </a>
                    </li>
                        </ul>
                    </li>
